...
const Heading = () => {
  ...
  return (
    <>
      <div className="max-w-3xl mt-32 md:mt-28 space-y-4 z-50 inset-0 w-full left-0 right-0 m-auto absolute flex justify-center text- dark:text-white pointer-events-none flex-col items-center">
